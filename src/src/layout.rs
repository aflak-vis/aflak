...
const EDITOR_WINDOW_DEFAULT_POSITION: [f32; 2] = [10.0, 10.0];
const EDITOR_WINDOW_DEFAULT_SIZE: (f32, f32) = (1200.0, 800.0);

const OUTPUT_WINDOW_DEFAULT_SIZE: [f32; 2] = [600.0, 400.0];
...
impl LayoutEngine {
    ...
    pub fn default_editor_layout(&self, display_size: [f32; 2]) -> Layout {

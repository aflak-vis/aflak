...
pub struct State {
    ...
    pub topology_brightness_radix: f32,
    pub topology_brightness_exp: i32,
    pub show_other_topology_settings: bool,
    pub topology_interval: f32,
    pub topology_width: f32,
    pub lut: ColorLUT,
...
impl Default for State {
    fn default() -> Self {
        State {
            ...
            topology_brightness_radix: 1.0,
            topology_brightness_exp: 1,
            show_other_topology_settings: false,
            topology_interval: 0.0,
            topology_width: 0.002,
